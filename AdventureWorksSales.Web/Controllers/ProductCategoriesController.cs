...
namespace AdventureWorksSales.Web.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ProductCategory productCategory = db.ProductCategories.Where(p=>p.ProductCategoryID == id).FirstOrDefault();
        ...
        public ActionResult Create([Bind(Include = "Name,rowguid,ModifiedDate")] ProductCategory productCategory)
        {
